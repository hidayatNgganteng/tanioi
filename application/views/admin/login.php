...
<head>
    ...
    .body{
        ...
        width: auto;
        height: auto;
        background-image: url("<?php echo base_url(); ?>assets/img/grass2.jpg");
...
<body>
    ...
    <div class="body"></div>
        ...
        <div class="login">
            ...
            <form method="POST" action="<?php echo base_url(); ?>admin/login_proccess">	
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <p style="color: #000000; font-size: 20px;"><?php echo $this->session->flashdata('message') ?></p>
                    </div>
